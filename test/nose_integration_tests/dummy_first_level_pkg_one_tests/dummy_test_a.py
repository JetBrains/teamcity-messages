...
def do_something(i):
    assert True, "do something number: {0}".format(i)
...
def test_with_generator_and_pydoc():
    ...
    """
    for i in range(0, 5):
        @attr(description="Do not worry, be happy {0}".format(i))
...
def do_something_else(i):
    ...
    """
    assert True, "do something else number: {0}".format(i)
...
def test_with_generator_and_description_and_pydoc():
    ...
    """
    for i in range(0, 5):
        @attr(description="Do not worry, be funky {0}".format(i))
        def wrapper(*args, **kwargs):
...
def do_something_funky(i):
    ...
    """
    if i == 1:
        assert False, "i do not want to be funky just yet {0}".format(i)
    elif i == 2:
        evil_non_existent_method()
    else:
        assert True, "do something funky number: {0}".format(i)
